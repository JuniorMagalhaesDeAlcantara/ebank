...
public Transaction transfer(Long fromCustomerId, Long toCustomerId, double amount, String description) {
    ...
    if (fromAccount != null && toAccount != null && fromAccount.getBalance() >= amount) {
        ...
        withdrawalTransaction.setAccount(fromAccount); // Associa a conta da transação de retirada
        ...
        depositTransaction.setAccount(toAccount); // Associa a conta da transação de depósito
